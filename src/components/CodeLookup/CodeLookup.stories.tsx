...
- **Responsive / RTL.** The dropdown is a portal with measured fixed positioning (direction-neutral); drill-down chevrons mirror (\`rtl:-scale-x-100\`). Domain colours are hard-coded Tailwind palette classes, not tokens.
