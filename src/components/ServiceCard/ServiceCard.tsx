              ...
              <div className="border-border flex items-center gap-2 border-t pt-2">
                ...
                {onManage && (
                  <button
                    ...
                    className="text-primary-800 hover:text-primary-900 dark:text-primary-300 dark:hover:text-primary-200 hover:bg-primary/10 ms-auto rounded px-3 py-1 text-sm font-medium transition-colors"
                  >
                    Manage
                  </button>
                )}
