    ...
    <Modal open={open} onOpenChange={onOpenChange} size="lg">
      <form onSubmit={handleSubmit}>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            {!config.useBasePrice && (
              <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-700">
                <label htmlFor="custom-price" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Custom Price
                </label>
          ...
          {/* Notes */}
          <div>
            <label htmlFor="employer-service-notes" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Internal Notes
            </label>
            <textarea
