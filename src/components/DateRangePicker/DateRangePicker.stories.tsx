...
- Layout/RTL: trigger is fixed \`w-[300px] text-left\`; presets panel \`border-r\`; range ends use \`rounded-l-md\` / \`rounded-r-md\`; \`DateRangeFilter\` icons use \`mr-2\` / \`ml-2\` — all physical. \`align="auto"\` flips using an estimated popup width (840px with presets, 640px without).
