...
const meta: Meta<typeof RecurringServiceCard> = {
  title: 'Layout & Structure/RecurringServiceCard',
...
export const AddCard: StoryObj<typeof RecurringServiceAddCard> = {
  render: () => (
    <div className="max-w-sm">
      <RecurringServiceAddCard onClick={() => window.alert('Add clicked')} />
    </div>
  ),
};

const setupModalProviders = [
  { id: '1', name: 'MedExpress Urgent Care' },
  { id: '2', name: 'Quest Diagnostics' },
  { id: '3', name: 'AudioHealth Center' },
];

const setupModalServices = [
  ...
  return (
    <>
      ...
      <RecurringServiceSetupModal
        ...
        providers={setupModalProviders}
        services={setupModalServices}
      />
    </>
  );
}
...
export const SetupModal: StoryObj<typeof RecurringServiceSetupModal> = {
  render: () => <SetupModalWrapper />,
};

function SetupModalBrandedPortalWrapper() {
  const [open, setOpen] = useState(true);
  ...
  return (
    <>
      ...
      <RecurringServiceSetupModal
        ...
        services={setupModalServices.slice(0, 3)}
      />
    </>
  );
}
