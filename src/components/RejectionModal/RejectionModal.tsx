        ...
        <ModalBody className="space-y-4">
          ...
          {variant === 'danger' && (
            <div className="border-destructive/30 bg-destructive/10 flex items-start gap-3 rounded-lg border p-3">
              <svg
                className="text-destructive-700 dark:text-destructive-400 mt-0.5 h-5 w-5 flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <p className="text-destructive-700 dark:text-destructive-400 text-sm">
