...
- **Responsive / RTL.** Rows are single-line \`flex\` with a truncating label; the nested picklist lanes use logical \`border-s-2\` / \`marginInlineStart\` and the expand chevron mirrors (\`rtl:-scale-x-100\`), so RTL mirrors.
