  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          React__namespace.isValidElement(icon) && icon,
          ...
          dismissible && /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.X, { size: 16, "aria-hidden": "true" })
            }
          )
        ]
      }
...
var AlertTitle = React__namespace.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  ...
  {
    ref,
    className: chunkOR5DRJCW_cjs.cn("mb-1 font-semibold leading-none tracking-tight", className),
    ...props,
    children
  }
));
...
//# sourceMappingURL=chunk-5N3GFFVP.cjs.map
//# sourceMappingURL=chunk-5N3GFFVP.cjs.map