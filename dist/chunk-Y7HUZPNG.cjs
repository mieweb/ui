...
function AudioPlayer({
  ...
  if (variant === "inline") {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkOR5DRJCW_cjs.cn(audioPlayerVariants({ variant, size }), className), children: [
      ...
      showDuration && displayDuration > 0 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-mono text-xs tabular-nums text-neutral-500 dark:text-neutral-400", children: isPlaying ? formatTime(currentTime) : formatTime(displayDuration) })
    ] });
  }
  if (variant === "compact") {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkOR5DRJCW_cjs.cn(audioPlayerVariants({ variant, size }), className), children: [
...
//# sourceMappingURL=chunk-Y7HUZPNG.cjs.map
//# sourceMappingURL=chunk-Y7HUZPNG.cjs.map