...
function Select({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkOR5DRJCW_cjs.cn("flex flex-col gap-1.5", className), children: [
      ...
      isOpen && reactDom.createPortal(
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              searchable && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "border-b border-border p-2", children: /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  ref: searchInputRef,
                  type: "text",
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                "ul",
                {
                  ...
                  children: filteredFlatOptions.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("li", { className: "px-3 py-2 text-center text-sm text-muted-foreground", children: noResultsText }) : filteredOptions.map((item) => {
                    if ("options" in item) {
                      return /* @__PURE__ */ jsxRuntime.jsxs("li", { role: "presentation", children: [
                        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: item.label }),
    ...
    error && /* @__PURE__ */ jsxRuntime.jsx("p", { id: errorId, className: "text-sm text-destructive", role: "alert", children: error }),
    helperText && !error && /* @__PURE__ */ jsxRuntime.jsx("p", { id: helperId, className: "text-sm text-muted-foreground", children: helperText })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "li",
    {
      ...
      children: [
        ...
        isSelected && /* @__PURE__ */ jsxRuntime.jsx(CheckIcon, { className: "h-4 w-4 shrink-0 text-primary-500" })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-GEKTNWTP.cjs.map
//# sourceMappingURL=chunk-GEKTNWTP.cjs.map