...
var chunkQE6UIZ6W_cjs = require('./chunk-QE6UIZ6W.cjs');
var chunkELQZWMU3_cjs = require('./chunk-ELQZWMU3.cjs');
...
function ThemeProvider({
  ...
  const { theme, setTheme, resolvedTheme } = chunkELQZWMU3_cjs.useTheme(defaultTheme);
...
var ThemeToggle = React__namespace.forwardRef(
  ({
    ...
    const { theme, setTheme, resolvedTheme } = chunkELQZWMU3_cjs.useTheme();
...
//# sourceMappingURL=chunk-Z5MOXAAV.cjs.map
//# sourceMappingURL=chunk-Z5MOXAAV.cjs.map