...
import {
  ...
  isDateInPast,
  isValidDate,
} from './chunk-SN52QMRT.js';
import { Input } from './chunk-TDUFAV5M.js';
...
var DateInput = React.forwardRef(
  (
    ...
    const autoComplete =
      mode === 'dob' ? 'bday' : mode === 'expiration' ? 'cc-exp' : void 0;
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsx('select', {
                    ...
                    className:
                      'rounded border border-border bg-background px-2 py-1 text-sm',
                    'aria-label': 'Select month',
                    children: monthNames.map((name, i) =>
                      /* @__PURE__ */ jsx(
                        'option',
                        { value: i, children: name },
                        name
                      )
                    ),
                  }),
                  /* @__PURE__ */ jsx('select', {
                    ...
                    children: Array.from(
                      { length: 150 },
                      (_, i) =>
                        /* @__PURE__ */ new Date().getFullYear() - 100 + i
                    ).map((year) =>
                      /* @__PURE__ */ jsx(
                        'option',
...
export { DateInput };
//# sourceMappingURL=chunk-6QCOOAEU.js.map
//# sourceMappingURL=chunk-6QCOOAEU.js.map
