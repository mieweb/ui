  ...
  (
    ...
    React.useEffect(() => {
      ...
      if (controlledState !== void 0 && transcriptionState !== void 0) {
        const mappedTranscriptionState =
          transcriptionState === 'error'
            ? 'error'
            : transcriptionState === 'transcribing' ||
                transcriptionState === 'streaming'
              ...
              : transcriptionState === 'complete'
                ...
                : void 0;
        if (
          mappedTranscriptionState !== void 0 &&
    ...
    const renderIcon = () => {
      switch (effectiveState) {
        case 'recording':
          ...
          return (
            recordingIcon ||
            /* @__PURE__ */ jsx(StopIcon, { className: iconSize })
          );
        case 'processing':
        ...
        default:
          return (
            idleIcon || /* @__PURE__ */ jsx(MicIcon, { className: iconSize })
          );
      }
    };
    const getAriaLabel = () => {
      ...
      children: [
        /* @__PURE__ */ jsxs('button', {
          ...
          children: [
            effectiveState === 'recording' &&
              showPulse &&
              /* @__PURE__ */ jsx(PulseRings, { variant }),
            /* @__PURE__ */ jsx('span', {
...
//# sourceMappingURL=chunk-IC45IA33.js.map
//# sourceMappingURL=chunk-IC45IA33.js.map
