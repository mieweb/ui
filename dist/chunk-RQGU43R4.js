...
function ProgressBar({ currentTime, duration, onSeek, disabled }) {
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsx('div', {
        className:
          'absolute inset-y-0 left-0 rounded-full bg-primary-600 transition-all',
        style: { width: `${progress}%` },
      }),
      /* @__PURE__ */ jsx('div', {
        className:
          'absolute top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-primary-600 shadow-sm transition-all',
...
function AudioPlayer({
  ...
  const renderPlayButton = () =>
    /* @__PURE__ */ jsx('button', {
      ...
      children: isLoading
        ? /* @__PURE__ */ jsx(SpinnerIcon, { className: iconSize })
        : isPlaying
          ? /* @__PURE__ */ jsx(PauseIcon, { className: iconSize })
          : /* @__PURE__ */ jsx(PlayIcon, { className: iconSize }),
    });
  ...
  const renderPlaybackRateControl = () => {
    ...
    return /* @__PURE__ */ jsx('select', {
      ...
      className:
        'rounded border border-neutral-200 bg-transparent px-1 py-0.5 text-xs dark:border-neutral-700',
      'aria-label': 'Playback speed',
      children: playbackRates.map((rate) =>
        /* @__PURE__ */ jsxs(
          'option',
          { value: rate, children: [rate, 'x'] },
          rate
        )
      ),
    });
    ...
    return /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        ...
        showDuration &&
          ...
          /* @__PURE__ */ jsx('span', {
            className:
              'font-mono text-xs tabular-nums text-neutral-500 dark:text-neutral-400',
            children: isPlaying
      ...
      /* @__PURE__ */ jsxs('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [renderTime(true), renderPlaybackRateControl()],
          }),
        ],
      }),
    ],
...
//# sourceMappingURL=chunk-RQGU43R4.js.map
//# sourceMappingURL=chunk-RQGU43R4.js.map
