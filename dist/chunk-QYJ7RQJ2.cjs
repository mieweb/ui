...
function CheckboxGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "fieldset",
    {
      ...
      "aria-describedby": [description ? descriptionId : null, error ? errorId : null].filter(Boolean).join(" ") || void 0,
      children: [
        label && /* @__PURE__ */ jsxRuntime.jsx("legend", { className: "text-foreground mb-1 text-sm font-medium", children: label }),
        description && /* @__PURE__ */ jsxRuntime.jsx("p", { id: descriptionId, className: "text-muted-foreground mb-3 text-xs", children: description }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            role: "group",
        ...
        error && /* @__PURE__ */ jsxRuntime.jsx("p", { id: errorId, className: "text-destructive mt-2 text-sm", role: "alert", children: error })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-QYJ7RQJ2.cjs.map
//# sourceMappingURL=chunk-QYJ7RQJ2.cjs.map