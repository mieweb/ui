    ...
    return /* @__PURE__ */ jsxs(Component, {
      ...
      children: [
        ...
        loading &&
          /* @__PURE__ */ jsx('div', {
            className:
              'bg-card/80 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-sm',
            children: /* @__PURE__ */ jsxs('div', {
              className: 'flex gap-1',
              children: [
                /* @__PURE__ */ jsx('div', {
                  className:
                    'h-2 w-2 animate-bounce rounded-full bg-primary-500 [animation-delay:-0.3s]',
                }),
                /* @__PURE__ */ jsx('div', {
                  className:
                    'h-2 w-2 animate-bounce rounded-full bg-primary-500 [animation-delay:-0.15s]',
                }),
                /* @__PURE__ */ jsx('div', {
                  className:
                    'h-2 w-2 animate-bounce rounded-full bg-primary-500',
                }),
              ],
            }),
          }),
...
var CardTitle = React.forwardRef(({ className, children, ...props }, ref) =>
  /* @__PURE__ */ jsx('h3', {
    ref,
    className: cn(
...
var CardContent = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx('div', { ref, className: cn('', className), ...props })
);
    ...
    return /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        ...
        overlay &&
          /* @__PURE__ */ jsx('div', {
            className:
              'absolute inset-0 flex items-end bg-gradient-to-t from-neutral-900/60 to-transparent p-4',
            children: overlay,
          }),
      ],
    });
...
var CardDivider = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx('hr', {
    ref,
    ...
    return /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        /* @__PURE__ */ jsx('button', {
          ...
          className:
            'flex items-center gap-1 rounded text-sm text-primary-600 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2',
  ...
  ({ className, value, label, trend, icon, ...props }, ref) => {
    return /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        icon &&
          /* @__PURE__ */ jsx('div', {
            className: 'bg-primary-500/10 rounded-lg p-2 text-primary-600',
            children: icon,
          }),
        /* @__PURE__ */ jsxs('div', {
...
//# sourceMappingURL=chunk-6Z4SPK4I.js.map
//# sourceMappingURL=chunk-6Z4SPK4I.js.map
