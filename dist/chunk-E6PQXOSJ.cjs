...
var RecordButton = React__namespace.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative inline-flex items-center gap-2", children: [
      ...
      showDuration && isRecording && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-mono text-xs tabular-nums text-destructive", children: formatDuration(duration) }),
...
//# sourceMappingURL=chunk-E6PQXOSJ.cjs.map
//# sourceMappingURL=chunk-E6PQXOSJ.cjs.map