...
function RecordingIndicator({ isRecording, isPaused }) {
...
function TimeDisplay({ currentTime, duration, maxDuration, showMax }) {
  return /* @__PURE__ */ jsxs('div', {
    className:
      'flex items-center gap-1 font-mono text-sm text-neutral-600 dark:text-neutral-400',
    children: [
      /* @__PURE__ */ jsx('span', { children: formatTime(currentTime) }),
      /* @__PURE__ */ jsx('span', { children: '/' }),
      /* @__PURE__ */ jsx('span', {
        children: formatTime(showMax && maxDuration ? maxDuration : duration),
      }),
    ],
  });
}
function LiveVisualizer({ analyser, isActive, height, barColor }) {
...
function AudioRecorder({
  ...
  const [audioObjectUrl, setAudioObjectUrl] = React.useState(null);
...
function DefaultControls({
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      ...
      (state === 'stopped' || (isPaused && hasRecording)) &&
        hasRecording &&
        /* @__PURE__ */ jsx('button', {
          type: 'button',
          ...
          children:
            isPaused || !isPlaying
              ? /* @__PURE__ */ jsx(PlayIcon, { className: 'h-6 w-6' })
              : /* @__PURE__ */ jsx(PauseIcon, { className: 'h-6 w-6' }),
        }),
      isPlaying &&
        /* @__PURE__ */ jsx('button', {
          type: 'button',
...
//# sourceMappingURL=chunk-MAJZ2W7V.js.map
//# sourceMappingURL=chunk-MAJZ2W7V.js.map
