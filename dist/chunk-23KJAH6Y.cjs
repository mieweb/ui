...
function Progress({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkOR5DRJCW_cjs.cn("w-full", className), children: [
    (label || showValue) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mb-1.5 flex items-center justify-between", children: [
      ...
      showValue && !indeterminate && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm text-muted-foreground", children: displayValue })
    ] }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        showValue && !indeterminate && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "absolute inset-0 flex items-center justify-center text-xs font-medium text-foreground", children: [
...
//# sourceMappingURL=chunk-23KJAH6Y.cjs.map
//# sourceMappingURL=chunk-23KJAH6Y.cjs.map