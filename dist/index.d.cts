...
export { R as ResolvedTheme, T as Theme, u as useTheme } from './useTheme-4pRCRjFK.cjs';
...
interface ConversationHeaderProps extends React$1.HTMLAttributes<HTMLElement>, VariantProps<typeof headerVariants$1> {
...
declare function VerifiedBadge({ isVerified, isClaimed, className, }: VerifiedBadgeProps): react_jsx_runtime.JSX.Element | null;
...
declare function ProviderDetailHeader({ provider, breadcrumbs, showActionButtons, showBreadcrumb, showSocialLinks, showVerifiedBadge, showClaimButton, showReportLink, showBookButton, onShare, onCopyLink: _onCopyLink, onCall, onBook, className, }: ProviderDetailHeaderProps): react_jsx_runtime.JSX.Element;
...
declare function ActionButtonsBar(_props: ActionButtonsBarProps): null;
