      ...
      Component,
      {
        ...
        children: [
          ...
          loading && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "bg-card/80 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-1", children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-2 w-2 animate-bounce rounded-full bg-primary-500 [animation-delay:-0.3s]" }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-2 w-2 animate-bounce rounded-full bg-primary-500 [animation-delay:-0.15s]" }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-2 w-2 animate-bounce rounded-full bg-primary-500" })
          ] }) }),
          children
        ]
      }
...
var CardDescription = React__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  ...
  {
    ref,
    className: chunkOR5DRJCW_cjs.cn("text-sm text-muted-foreground", className),
    ...props
  }
));
...
var CardDivider = React__namespace.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
  ...
  {
    ref,
    className: chunkOR5DRJCW_cjs.cn("-mx-4 my-4 border-border", className),
    ...props
  }
));
  ...
  ({ className, value, label, trend, icon, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          icon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "bg-primary-500/10 rounded-lg p-2 text-primary-600", children: icon }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-2xl font-bold tracking-tight", children: value }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-sm text-muted-foreground", children: label }),
...
//# sourceMappingURL=chunk-OGGM27JO.cjs.map
//# sourceMappingURL=chunk-OGGM27JO.cjs.map