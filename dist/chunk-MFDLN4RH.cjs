...
function CheckboxGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "fieldset",
    {
      ...
      "aria-describedby": [description ? descriptionId : null, error ? errorId : null].filter(Boolean).join(" ") || void 0,
      children: [
        label && /* @__PURE__ */ jsxRuntime.jsx("legend", { className: "mb-1 text-sm font-medium text-foreground", children: label }),
        description && /* @__PURE__ */ jsxRuntime.jsx("p", { id: descriptionId, className: "mb-3 text-xs text-muted-foreground", children: description }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            role: "group",
        ...
        error && /* @__PURE__ */ jsxRuntime.jsx("p", { id: errorId, className: "mt-2 text-sm text-destructive", role: "alert", children: error })
      ]
    }
  );
}
...
function MinusIcon({ size, className }) {
  const sizeMap = {
    sm: 10,
    md: 12,
    lg: 14
...
//# sourceMappingURL=chunk-MFDLN4RH.cjs.map
//# sourceMappingURL=chunk-MFDLN4RH.cjs.map