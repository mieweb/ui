 ...
 * ```
 */
declare function DocumentScannerModal({ open, onOpenChange, onScan, onResult, title, description, multiple, acceptedFileTypes, maxFileSizeMb, disabled, enableWebcam, enableCamera, onValidationError, onStateChange, size, className, closeOnSuccess, }: DocumentScannerModalProps): react_jsx_runtime.JSX.Element;
declare namespace DocumentScannerModal {
    var displayName: string;
}
