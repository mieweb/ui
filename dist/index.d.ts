 ...
 * ```
 */
declare function ResultsEntryForm({ employeeFirstName, employeeLastName, initialData, providerContacts, showFileUpload, showApplyToAll, onSubmit, labels, className, }: ResultsEntryFormProps): react_jsx_runtime.JSX.Element;
 ...
 */
declare function ResultsEntryCard({ serviceName, employeeFirstName, employeeLastName, isOpen, onClose, onSubmit, labels, ...props }: ResultsEntryModalProps): react_jsx_runtime.JSX.Element | null;
