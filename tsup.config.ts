...
export default defineConfig({
  entry: {
    ...
    // Portal component subpaths must match package.json wildcard exports.
    'components/ActivityFeed/index': 'src/components/ActivityFeed/index.ts',
    'components/ConfirmDialog/index': 'src/components/ConfirmDialog/index.ts',
    'components/HeroActionCard/index': 'src/components/HeroActionCard/index.ts',
    'components/IconBadge/index': 'src/components/IconBadge/index.ts',
    'components/LiveOrderTracker/index': 'src/components/LiveOrderTracker/index.ts',
    'components/NearbyProviderCard/index': 'src/components/NearbyProviderCard/index.ts',
    'components/OTPInput/index': 'src/components/OTPInput/index.ts',
    'components/PhoneNumber/index': 'src/components/PhoneNumber/index.ts',
    'components/PortalShell/index': 'src/components/PortalShell/index.ts',
    'components/ProviderMap/index': 'src/components/ProviderMap/index.ts',
    'components/StatCard/index': 'src/components/StatCard/index.ts',
    'components/UserAvatar/index': 'src/components/UserAvatar/index.ts',
    'components/UserBadge/index': 'src/components/UserBadge/index.ts',
    'components/WorkspaceSwitcher/index': 'src/components/WorkspaceSwitcher/index.ts',
